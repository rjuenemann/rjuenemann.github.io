...
### Integrating the EcoCyc database with the whole-cell model
Read the publication [here](https://journals.asm.org/doi/10.1128/ecosalplus.esp-0019-2024)!  
In collaboration with the EcoCyc team, we ingest updates from the curated EcoCyc _E. coli_ database into the whole-cell model to keep its underlying biological data current. In turn, we surface whole-cell model predictions on the EcoCyc website, making the model's outputs more accessible to the broader research community.
...
## Particle movement and filament network analysis
...
_Bulletin of Mathematical Biology_, 83(10), (2021). [DOI](https://link.springer.com/article/10.1007/s11538-020-00847-3) · [PDF](https://drive.google.com/file/d/1rkhhSyLqyDLW89z8U8ye3FN9Ow4nhOOS/view?usp=sharing) · [arXiv](https://arxiv.org/abs/1910.05850)  
